...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch("https://contact-api-production-99c0.up.railway.app/send", {
        method: "POST",
      ...
      alert(data.message);
      setFormData({ name: '', surname: '', number: '', email: '', message: '' }); // Formu temizle
    } catch (error) {
